...
const ResortDashboardPage = lazy(
  () => import("./pages/dashboard/ResortDashboardPage"),
);
const TentDashboardPage = lazy(
  () => import("./pages/dashboard/TentDashboardPage"),
);
const TouristSpotDashboardPage = lazy(
  () => import("./pages/dashboard/TouristSpotDashboardPage"),
);

const VanaReportPage = lazy(
  () => import("./pages/DailyOccupancyReport/VanaVihariReport"),
);
const JunglestarReportPage = lazy(
  () => import("./pages/DailyOccupancyReport/JungleStarReport"),
);
...
const VanavihariReportConsolidationPage = lazy(
  () => import("./pages/consolidationReport/VanavihariConsolidationReport"),
);
...
const AllTouristBookingsPage = lazy(
  () => import("./pages/touristBookings/AllTouristBookingsPage"),
);
const AddTouristBookingPage = lazy(
  () => import("./pages/touristBookings/AddTouristBookingPage"),
);
      ...
      <Routes>
        ...
        >
          ...
          <Route
            ...
            element={<TouristSpotDashboardPage />}
          />
          <Route
            path="dailyoccupanyreport/vanavihari"
            element={<VanaReportPage />}
          />
          <Route
            path="dailyoccupanyreport/junglestar"
            element={<JunglestarReportPage />}
          />
          <Route
            path="frontdesk/checkin"
            element={
              <RoleGuard pageId="frontdesk">
                <CheckInPage />
              </RoleGuard>
            }
          />
          ...
          <Route
            ...
            element={
              <RoleGuard pageId="reservations-add">
                <AddReservationPage />
              </RoleGuard>
            }
          />
          <Route
            ...
            element={
              <RoleGuard pageId="reservations-view">
                <AllReservationPage />
              </RoleGuard>
            }
          />
          <Route
            path="cottage-types/all"
            element={
              <RoleGuard pageId="cottage-types-view">
                <AllCottageTypePage />
              </RoleGuard>
            }
          />
          <Route
            path="cottage-types/add"
            element={
              <RoleGuard pageId="cottage-types-add">
                <AddCottageTypePage />
              </RoleGuard>
            }
          />
          <Route
            ...
            element={
              <RoleGuard pageId="room-amenities-view">
                <AllRoomAmenitiesPage />
              </RoleGuard>
            }
          />
          <Route
            ...
            element={
              <RoleGuard pageId="room-amenities-add">
                <AddRoomAmenitiesPage />
              </RoleGuard>
            }
          />
          <Route
            path="touristspots/add"
            element={
              <RoleGuard pageId="tourist-spots-add">
                <AddTouristSpot />
              </RoleGuard>
            }
          />
          <Route
            path="touristspots/all"
            element={
              <RoleGuard pageId="tourist-spots-view">
                <AllTouristSpot />
              </RoleGuard>
            }
          />
          <Route
            path="tenttypes/add"
            element={
              <RoleGuard pageId="tent-types-add">
                <AddTentTypes />
              </RoleGuard>
            }
          />
          <Route
            path="tenttypes/all"
            element={
              <RoleGuard pageId="tent-types-view">
                <AllTentTypes />
              </RoleGuard>
            }
          />
          <Route
            path="tentspots/add"
            element={
              <RoleGuard pageId="tent-spots-add">
                <AddTentSpots />
              </RoleGuard>
            }
          />
          <Route
            path="tentspots/all"
            element={
              <RoleGuard pageId="tent-spots-view">
                <AllTentSpots />
              </RoleGuard>
            }
          />
          <Route
            path="tentspots/details"
            element={
              <RoleGuard pageId="tent-spots-view">
                <AddTentSpots />
              </RoleGuard>
          ...
          />
          <Route
            path="tentbookings/allbookings"
            element={
              <RoleGuard pageId="tent-bookings-view">
                <AllTentBook />
              </RoleGuard>
            }
          />
          <Route
            path="tentbookings/addbookings"
            element={
              <RoleGuard pageId="tent-bookings-add">
                <AddTentBook />
              </RoleGuard>
            }
          />
          <Route
            ...
            element={
              <RoleGuard pageId="tourist-bookings-view">
                <AllTouristBookingsPage />
              </RoleGuard>
            }
          />
          <Route
            path="tourist/bookings/add"
            element={
              <RoleGuard pageId="tourist-bookings-add">
                <AddTouristBookingPage />
              </RoleGuard>
            }
          />
          <Route
            path="reports/daily-occupancy-junglestar"
            element={<JunglestarReportPage />}
          />
          <Route
            path="reports/daily-occupancy-vanavihari"
            element={<VanaReportPage />}
          />
          <Route
            path="reports/consolidation-report-vanavihari"
            element={<VanavihariReportConsolidationPage />}
          />
          <Route
            path="tentinventory/addtents"
            element={
              <RoleGuard pageId="tent-inventory-add">
                <AddTents />
              </RoleGuard>
            }
          />
          <Route
            path="tentinventory/alltents"
            element={
              <RoleGuard pageId="tent-inventory-view">
                <AllTents />
              </RoleGuard>
            }
          />
          <Route
            path="users/manage"
            element={
              <RoleGuard pageId="user-management">
                <UserManagementPage />
              </RoleGuard>
            }
          />
