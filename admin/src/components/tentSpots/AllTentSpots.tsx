    ...
    <div className="flex flex-col h-full max-h-screen overflow-hidden py-6">
      <style>{`
        @media (max-width: 768px) {
          .tent-spots-table-container .dt-layout-row {
          ...
          .tent-spots-table-container .dt-layout-cell {
            display: inline-flex !important;
            align-items: center !important;
            flex-wrap: nowrap !important;
          }

          .tent-spots-table-container .dt-layout-start {
            order: 1 !important;
          }

          .tent-spots-table-container .dt-layout-end {
            order: 2 !important;
            margin-left: auto !important;
          }

          .tent-spots-table-container .dt-buttons {
            display: inline-flex !important;
          }

          .tent-spots-table-container .dt-buttons button {
            font-size: 11px !important;
            padding: 4px 8px !important;
            white-space: nowrap !important;
          }

          .tent-spots-table-container .dt-search {
            display: inline-flex !important;
            align-items: center !important;
          }

          .tent-spots-table-container .dt-search input {
            font-size: 10px !important;
            padding: 4px 6px !important;
            width: 140px !important;
          }

          .tent-spots-table-container .dt-length {
            order: 3 !important;
            flex-basis: 100% !important;
            margin-top: 8px !important;
          }

          .tent-spots-table-container .dt-length select {
            font-size: 11px !important;
            padding: 4px 6px !important;
          }

          .tent-spots-table-container .dt-length label {
            font-size: 11px !important;
          }

          .tent-spots-table-container .dt-paging {
            order: 4 !important;
            flex-basis: 100% !important;
            margin-top: 8px !important;
            display: flex !important;
          ...
          .tent-spots-table-container .dt-paging button {
            font-size: 10px !important;
            padding: 4px 8px !important;
          }

          .tent-spots-table-container .dt-info {
      ...
      <div className="flex items-center justify-between mb-4 flex-shrink-0">
        ...
        <ExportButton
          ...
          filename="Tent_Spots_Records.csv"
      ...
      >
        {isLoading && <PageLoader message="Loading tent spots..." />}
        {loadError && (
